...
## Installation
If you have setup a private ssh key for your github, copy-paste the command below to install the latest version ([v0.34.0][latest_tag]):
```
$ pip install git+ssh://git@github.com/sg-dev/rel2graph@v0.4.0
```
...
[latest_tag]: https://github.com/sg-dev/rel2graph/releases/tag/v0.4.0
[latest_wheel]: https://github.com/sg-dev/rel2graph/releases/download/v0.4.0/rel2graph-0.4.0-py3-none-any.whl
