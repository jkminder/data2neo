...
```
pip install git+ssh://git@github.com/sg-dev/rel2graph@v1.2.2
```
...
[latest_tag]: https://github.com/sg-dev/rel2graph/releases/tag/v1.2.2
[latest_wheel]: https://github.com/sg-dev/rel2graph/releases/download/v1.2.2/rel2graph-1.0.1-py3-none-any.whl
